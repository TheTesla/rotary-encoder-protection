...
def f(x, y, z):
    ...
    mcbtm = bd.fz_cuboid((x+8.0,ya,z-6), (40.,20.,14.8),0.5)
    ccbtm = bd.fz_cuboid((x+10.0,ya,z+3), (42.,40.,24.8),0.5)
    bodybtm = bd.fz_cuboid((x+9.5,ya,z-5), (50., 31.,25.), 0.5)
    pcbtm = bd.fz_cuboid((x+22,ya,z-7.4), (8.,30.,16.5),0.5)
    scbtm = bd.fz_cuboid((x-5,ya,z-6.4), (8.,29.,16.5),0.5)


    bottom = cmb.fz_and_chamfer(0.5, bodybtm, -top, -mcbtm, -ccbtm, -pcbtm, -scbtm, -hole)
